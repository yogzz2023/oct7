...
def plot_tracks(tracks, track_id_list):
    # Create a figure with three subplots
    fig, (ax1, ax2, ax3) = plt.subplots(3, 1, figsize=(12, 15))
    fig.suptitle('Track Measurements and State Estimates')

    # Define colors for each track (up to 10 tracks)
    ...
    for track_id, track in enumerate(tracks):
        if track_id_list[track_id]['state'] == 'occupied':
            ...
            # Extract time, measurements, and state estimates
            ...
            # Extract state estimates (assuming Sf is stored with each measurement)
    ...
    # Save the plot
    plt.savefig('track_plots.png')
    print("Track plots have been saved as 'track_plots.png'")

def main():
# Modify your main function to include the plottingdef main():
    file_path = 'ttk.csv'
    ...
    plot_tracks(tracks, track_id_list)
